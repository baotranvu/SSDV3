# 🏛️ UI/UX Design Sketch & Blueprint: VietnamTravel3D (Official v2 Archive)
...
![Mockup Cấp độ 1: Tổng quan Vùng miền (Regions Overview)](./mockups/level1_overview.png)
...
![Mockup Cấp độ 2: Chi tiết Vùng Bắc Bộ (North Region Detail)](./mockups/level2_north.png)
...
![Mockup Cấp độ 2: Chi tiết Vùng Trung Bộ (Central Region Detail)](./mockups/level2_central.png)
...
![Mockup Cấp độ 2: Chi tiết Vùng Nam Bộ (South Region Detail)](./mockups/level2_south.png)
...
![Mockup Cấp độ 2: Chi tiết Vùng Biển Đảo (Islands Detail)](./mockups/level2_islands.png)
...
![Mockup Cấp độ 3A: Chi tiết Địa danh - Chế độ Mô hình 3D (3D Blueprint Mode)](./mockups/level3_blueprint.png)
...
![Mockup Cấp độ 3B: Chi tiết Địa danh - Chế độ Xem VR 360 Góc nổi bật (VR Panorama Mode)](./mockups/level3_vr360.png)
